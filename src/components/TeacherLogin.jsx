...
const TeacherLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('/api/v1/teachers/login', payload, {
  ...
  useEffect(() => {
    const checkAuth = async () => {
      const response = await axios.get('/api/v1/teachers/me', { withCredentials: true });
      if (response?.data?.success) {
        navigate('/teacher/dashboard')
      }
    }
          ...
          <div className="p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-sm text-gray-500 dark:text-zinc-400 black:text-[#888] mt-1.5">
                Sign in as{" "}
                <span className="text-[#ba7a4e] font-semibold capitalize">Teacher</span>
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between pt-0.5">
                ...
                <button
                  onClick={() => { navigate("/t-fe7$nf!fd7/forgot-password")}}
                  type="button"
